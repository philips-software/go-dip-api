...
We'd love for you to contribute to our source code and to make the go-dip-api even better than it is today!
...
In Github, send a pull request to original master branch: f.e. `go-dip-api:master`.
